        ...
        <section>
          ...
          <label for="productName">Référence:</label>
              ...
              <textarea
                ...
                id="description"
                name="description"
              ><?php echo $result['pro_description']; ?></textarea></div>
              <div class="form-group">
            ...
            <label>Produit bloqué? :</label>
               <br />
              <input type="radio" id="oui" name="bloque" value="1"  <?php if($result['pro_bloque']==1) {echo 'checked'; }?>/> <label for="oui">Oui</label>
              <input type="radio" id="non" name="bloque" value="0"  <?php if($result['pro_bloque']== 0 || NULL ) {echo 'checked'; }?> readonly/> <label for="non"> Non </label>
