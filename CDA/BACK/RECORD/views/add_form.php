    ...
    <div class="row">
        <?php 
            if(isset($formError) && isset($fileError) && sizeof($formError) === 0 && sizeof($fileError) === 0 && isset($_POST['submit'])){
                    ...
                    $crud->addDisc($disc_title, $disc_year, $disc_picture, $disc_label, $disc_genre, $disc_price, $artist_id);
        ?>
            <div class="alert alert-success my-5" >la disque a bien ajouté </div>
        <?php
        } else {
            ?>
