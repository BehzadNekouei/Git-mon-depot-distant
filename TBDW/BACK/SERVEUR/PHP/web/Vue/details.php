...
?>
      <div>
        <section>
          <br><br>
          <div><img class="mx-auto d-block img-fluid col-4" src="/bnekouei/Contenu/img/<?php echo $result['pro_id'] ?>.<?php echo $result['pro_photo'] ?>" alt=""></div>
          <br><br>
          ...
          <label for="productName">Référence:</label>
              ...
              <input
                ...
                name="libelle"
                id="libelle"
                value="<?php echo $result['pro_libelle']; ?>"
                readonly
              /><br />
              ...
              <input
                ...
                name="prix"
                id="prix"
                value="<?php echo $result['pro_prix']; ?>"
                readonly
              /><br />
              ...
              <input
                ...
                name="stock"
                id="stock"
                value="<?php echo $result['pro_stock']; ?>"
                readonly
              /><br />
              ...
              <input
                ...
                name="couleur"
                id="couleur"
                value="<?php echo $result['pro_couleur']; ?>"
                readonly
              /><br />
            <label>Produit bloqué?:</label>
               <br />
              <input type="radio" id="oui" name="bloque" value="1" disabled <?php if($result['pro_bloque']==1) {echo 'checked'; }?>/> <label for="oui">Oui</label>
              <input type="radio" id="non" name="bloque" value="0" disabled <?php if($result['pro_bloque']== 0 || NULL ) {echo 'checked'; }?> readonly/> <label for="non"> Non </label>
              ...
              <input
                ...
                name="ddj"
                id="ddj"
                value="<?php echo $result['pro_d_ajout']; ?>"
                readonly
              /><br />
              ...
              <input
                ...
                name="ddm"
                id="ddm"
                value="<?php echo $result['pro_d_modif']; ?>"
                readonly
              /><br />
          </form>
        </section>
